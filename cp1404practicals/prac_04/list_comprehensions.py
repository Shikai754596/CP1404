...
lowercase_full_names = [name.lower() for name in names]  # in lowercase format
print(lowercase_full_names)  # lowercase_full_names =

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# TODO: use a list comprehension to create a list of integers
numbers = [int(number) for number in almost_numbers]  # from the above list of strings
